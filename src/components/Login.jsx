    ...
    <AnimatePresence>
      {isOpen && (
        ...
        >
          ...
          >
             <h2 className="text-2xl font-bold mb-4 text-primary">Masuk</h2>
              <form className="space-y-4">
                <div>
                  ...
                  <input
                    ...
                    name="email"
                    required
                    className="mt-1 block w-full rounded-md border-gray-300 shadow-sm focus:border-primary focus:ring focus:ring-primary focus:ring-opacity-50 bg-gray-200"
                  />
                </div>
                <div>
